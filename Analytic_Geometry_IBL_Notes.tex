...
\item
\end{enumerate}
%Have students recount what they did (likely draw a line with arrows, label 0, then give a scale)
%Describe that this is the process of putting a coordinate system on a space.
\eq
...
\bq When describing a change, be sure to tell \underline{how much} of a change occurred \underline{and} what \underline{direction} the change was in. Using the points from Question \ref{qq1}, answer the following questions.
\be
...
\bq What angle do the following lines make with the horizontal axis?
\be
\item $x+y+1=0$
\item $4x-2y+6=0$
\item $-3x+5y-4=0$
...
\begin{center} \includegraphics[scale=.4]{p2.png} \end{center}
\eq
...
\bq If the orbit of the Moon around the Earth varies from \break221,463 miles to 252,710 miles, find the eccentricity of the Moon's orbit and the lengths of the major and minor axes. Note that the distances given are not $a$ and $b$ (see Question \ref{eq1}).
\eq

\question The ellipse in Washington DC is 3525 feet by 1265 feet. Give an equation for the edge of the ellipse if the axes are placed in the center with the \underline{$y$-axis as the major axis}.
...
\question Give parametric equations for the circle centered at the origin of radius 1. Be sure to give the bounds of your parameter $t$. Plot your parametric equations to confirm your answer.
